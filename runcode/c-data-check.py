"""Quick FITS waterfall plot check.

Usage:
  python c-data-check.py 0   # M01
  python c-data-check.py 1   # M02

Before running, edit the data_path and save_path values at the bottom of this
file. This is a lightweight data-inspection helper, not the PBS search entry.
"""
