...
if __name__ == '__main__':
    ...
    section_size              = 19 # file_number // max_section
    prob                      = 0.5
    block_size                = 512
    base_model                = 'resnet18'
    model_path                = './best_model_resnet18_fix_n4.pth'

    frb, DM                   = 'FRB20240114A', 527
    date                      = '20250502'
    print(frb, DM)


    date_path                 = '/data31/ZD2024_5/{}/{}/'.format(frb, date)
    save_path                 = '/path/to/observations/{}/CalData/{}/'.format(frb, date)
